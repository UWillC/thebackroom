-- ============================================
-- MIGRATION FIX: Enterprise Rooms v1.0 → v1.1
-- Data: 2026-02-06
-- ============================================
...
-- 6. DROP i CREATE view room_active_members (nie można zmienić kolumn przez REPLACE)
DROP VIEW IF EXISTS room_active_members;
CREATE VIEW room_active_members AS
SELECT
    rm.id,
    rm.room_id,
    rm.profile_id,
...
-- 7. DROP i CREATE view inbox_unread
DROP VIEW IF EXISTS inbox_unread;
CREATE VIEW inbox_unread AS
SELECT
